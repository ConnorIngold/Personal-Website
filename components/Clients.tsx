...
const Clients = () => {
	const clients = [
		...
		},
		{
			...
			image: '/images/clients/bbc/billionaire_boys_club_logo.png',
			width: 236,
			height: 100,
		},
		{
		...
		},
		{
			id: 4,
			name: 'dandd-logo',
			image: '/images/clients/doisyanddam/dandd-logo.avif',
			width: 236,
			height: 100,
		},
		{
			id: 5,
			name: 'RNLI',
			image: '/images/clients/rnli/RNLI_logo.png',
			width: 236,
			height: 100,
		},
		{
			id: 6,
			name: 'Roomix',
			image: '/images/clients/roomix/Roomix_Logo.avif',
			width: 236,
			height: 100,
		},
		{
