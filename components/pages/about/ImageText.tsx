		...
		<div className="flex flex-col items-center justify-center gap-10 py-5 border-t lg:py-10 md:flex-row md:justify-between">
			...
			<div className="md:w-1/3">
				...
				<p className="text-center md:text-left">
					Experience and the inevitable highs and lows of life have brought me to this point in my career. At just {new Date().getFullYear() - 1998} years of age, I have already gained {new Date().getFullYear() - 2018}+ years of valuable
					...
					determined than ever before. Today, I proudly call myself a member of a top UK agency, where I continue to hone my craft and push the boundaries of what is possible
