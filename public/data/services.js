export const services = [
	{
		icon: (
			<svg className="w-full" width="86" height="87" viewBox="0 0 86 87" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	{
		icon: (
			<svg className="w-full" width="91" height="84" viewBox="0 0 91 84" fill="none" xmlns="http://www.w3.org/2000/svg">
				<rect x="0.5" y="1.125" width="75" height="75" stroke="#1A1918" />
	...
	{
		icon: (
			<svg className="w-full" width="88" height="91" viewBox="0 0 88 91" fill="none" xmlns="http://www.w3.org/2000/svg">
				<rect x="0.5" y="1.125" width="75" height="75" stroke="#1A1918" />
	...
	{
		icon: (
			<svg className="w-full" width="83" height="89" viewBox="0 0 83 89" fill="none" xmlns="http://www.w3.org/2000/svg">
				<rect x="0.5" y="1.125" width="75" height="75" stroke="#1A1918" />
